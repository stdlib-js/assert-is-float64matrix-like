...
```javascript
isFloat64MatrixLike = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-float64matrix-like@v0.2.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/assert-is-float64matrix-like/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/assert-is-float64matrix-like/actions/workflows/test.yml?query=branch:v0.2.0
